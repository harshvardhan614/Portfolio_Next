      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6  md:gap-8 w-full">
        ...
        >
          <img
            ...
            src={`https://github-readme-stats.vercel.app/api/top-langs?username=harshvardhan614&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false`}
         ...
         <ItemLayout className={"col-span-full md:col-span-8 !p-0"}>
          <img
            className="w-full h-auto"
            src={`https://github-readme-stats.vercel.app/api?username=harshvardhan614&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false`}
            alt="504 Error! Reload again."
            loading="lazy"
          />
        </ItemLayout> 
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          <img
            className="w-full h-auto"
            src={` https://github-readme-streak-stats.herokuapp.com/?user=harshvardhan614&theme=dark&hide_border=true&type=svg&background=EB545400&ring=FEFE5B&currStreakLabel=FEFE5B`}
            alt="504 Error! Reload again."
            loading="lazy"
          />
        </ItemLayout>
        ...
        <ItemLayout className={"col-span-full md:col-span-6 !p-0"}>
          ...
          >
            <img
              className="w-full h-auto"
              src={`https://github-readme-stats.vercel.app/api/pin/?username=harshvardhan614&repo=Portfolio_Next&theme=transparent&hide_border=true&title_color=FEFE5B&text_color=FFFFFF&icon_color=FEFE5B&text_bold=false&description_lines_count=2`}
              alt="504 Error! Reload again."
              loading="lazy"
            />
          </Link>
