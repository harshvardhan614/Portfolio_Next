function ComputerModel({ nodes, materials, scale, position, rotation }) {
	return (
		<group
			scale={scale}
			position={position}
		...
		>
			<group scale={0.01}>
				...
				<mesh
					geometry={
						nodes.aorus_case_fans001_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans002_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans003_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans004_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans005_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans006_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans007_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans008_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.aorus_case_fans009_aorus_case_fans_0.geometry
					}
					material={materials["Material.074_0"]}
				...
				<mesh
					geometry={
						nodes.MOBOAORUSORANGETRANS_MOBOAORUSORANGETRANS_0
							.geometry
					}
				...
				<mesh
					geometry={
						nodes["metal-mesh-500x500_metal-mesh-500x500_0"]
							.geometry
					}
				...
				<mesh
					geometry={
						nodes["metal-mesh-500x500001_metal-mesh-500x500_0"]
							.geometry
					}
					material={materials["Material.074_5"]}
				...
				<mesh
					geometry={
						nodes["metal-mesh-500x500002_metal-mesh-500x500_0"]
							.geometry
					}
					material={materials["Material.074_5"]}
				...
				<mesh
					geometry={
						nodes["metal-mesh-500x500003_metal-mesh-500x500_0"]
							.geometry
					}
					material={materials["Material.074_5"]}
				...
				<mesh
					geometry={
						nodes["metal-mesh-500x500004_metal-mesh-500x500_0"]
							.geometry
					}
					material={materials["Material.074_5"]}
				...
				<mesh
					geometry={
						nodes["gigabyte-logo001_gigabyte-logo_0"].geometry
					}
					material={materials["Material.074_31"]}
